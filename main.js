...
var $author$project$Main$randomKingyo = A6(
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{draft: '', id: $elm$core$Maybe$Nothing, kingyos: _List_Nil, moving: false, name: '', players: _List_Nil, room: '', x: 400, y: 400},
		A2(
			$elm$random$Random$generate,
			$author$project$Types$KingyoGenerated,
			A2($elm$random$Random$list, 2, $author$project$Main$randomKingyo)));
};
...
var $author$project$Main$moveInfo = _Platform_incomingPort(
	'moveInfo',
	A2(
...
var $author$project$Main$skywayId = _Platform_incomingPort('skywayId', $elm$json$Json$Decode$string);
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$moveInfo($author$project$Types$Recv),
				$author$project$Main$skywayId($author$project$Types$IdDefined)
			]));
};
...
var $author$project$Main$join = _Platform_outgoingPort('join', $elm$json$Json$Encode$string);
...
var $author$project$Main$sendXY = _Platform_outgoingPort(
	'sendXY',
	function ($) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Join':
				return _Utils_Tuple2(
					model,
					$author$project$Main$join(model.room));
			case 'IdDefined':
				var id = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$amiView = function (p) {
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$pondHeight = 800;
var $author$project$Main$pondWidth = 800;
